...
/**
 * \mainpage Лабораторная работа №6-7
 * Программа получает на вход в первой строку название университета ("MIEM"/"MGTUU"), во второй пол
 * студента ("man"/"woman"), в третей год месяц и день рождения через пробел.
 * После чего возвращает уникальный номер студенческого билета для данного студента.\n\n
 *
 * Ввод:\n\n
 * miem\n
 * man\n
